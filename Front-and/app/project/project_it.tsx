...
/**
 * PROJECT INFO PAGE - Informácie o projekte a tutoriál
 */
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.content}>
          ...
          >
            ...
            <Text style={[styles.sectionText, { color: colors.textSecondary }]}>
              Viewer V2 je vylepšená verzia prehliadača projektov s ďalšími možnosťami a funkcionalitou. Skúste obe verzie a vyberte si tú, ktorá vám vyhovuje najviac.
            </Text>
          </View>
